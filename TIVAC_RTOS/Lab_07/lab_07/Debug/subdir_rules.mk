...
build-1605913745:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1605913745-inproc

build-1605913745-inproc: ../empty.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1605913745 ../empty.cfg
configPkg/compiler.opt: build-1605913745
configPkg/: build-1605913745
