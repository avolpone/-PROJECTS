...
//Initializes the TSL2591 to have a medium gain,
{
    ...
    x = I2C0_Read (0x29, (TSL2591_COMMAND_BIT | TSL2591_ID));   //read the device ID
    if (x == 0x00)
    {
...
int main(void)
{
    ...
    HibernateRTCMatchSet (0, 30); //hibernate for 30 minutes
    ...
    usprintf (HTTP_POST, "GET /update?key=GDIV09J7SJ8I7WPZ&field1=%d&headers=falseHTTP/1.1\nHostapi.thingspeak.com\nConnection:close\Accept*\*\r\n\r\n", luxAvg);
